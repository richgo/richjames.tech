...
Each task has a recommended model based on its type:
...
Flo built itself. 26 of 27 tasks were completed using Flo's own task management system. We used Claude to architect, Copilot to refactor, and auto-failover when quota ran out.
...
### The approach: Six layers in action

#### Layer 1: Human

Rich texts me via WhatsApp: "Migrate the website to Next.js and redesign it with a modern dark theme."

#### Layer 2: Interface

WhatsApp message arrives in OpenClaw.

#### Layer 3: Orchestrator

I (Jambo) receive the request, analyze the scope, and decide to use Flo for task management.

#### Layer 4: Flo

I create three tasks:
...
Flo routes each task to the optimal backend. I use GitHub CLI (`gh copilot`) to generate code, Claude for architectural decisions, Gemini for design thinking.

#### Layer 6: Deliverable

The result is richjames.tech — a fully modernized Next.js 14 site with:
...
### The real vision: Conversational SDLC
...
The diagram shows the complete abstraction stack:
